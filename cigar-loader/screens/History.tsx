 ...
 const HistoryScreen: React.FC = () => {
  ...
  return (
    <ScrollView scrollEnabled>
      <Block onStartShouldSetResponder={() => true} margin={sizes.s}>
        <Text h5 marginBottom={sizes.padding}>
          Notiser
        </Text>
        {Object.keys(notifications).map((date, key) => {
          return (
            <Block row flex={1}>
              <Block flex={1} row>
                <Block align="center" justify="flex-start">
                  <Text margin={0} padding={0} primary>
